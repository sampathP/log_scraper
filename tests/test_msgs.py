...
DHCPS_UNKOWN = ['Aug  5 04:13:06 buffalo.setup  [50:C4:DD:C0:66:F8] AP50C4DDC066F8 : DHCPS: Unable to pick client address: no IPv6 pools on this shared network\n']

DHCPS_ICMP_ECO ['Aug  2 11:17:47 buffalo.setup  [50:C4:DD:C0:66:F8] AP50C4DDC066F8 : DHCPS: ICMP Echo reply while lease 192.168.11.124 valid.\n', 'Aug  4 15:17:39 buffalo.setup  [50:C4:DD:C0:66:F8] AP50C4DDC066F8 : DHCPS: ICMP Echo reply while lease 192.168.11.127 valid.\n']
